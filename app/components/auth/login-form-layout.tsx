...
export default function LoginFormLayout({
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-[#f4f7f4]">
      <div
        className={`
            ...
            <div className="relative flex min-h-screen flex-col justify-between p-10 xl:p-14">
              ...
              <div className="max-w-xl">
                ...
                <h2 className="text-4xl font-bold leading-tight tracking-tight text-white xl:text-6xl">
                  Every cast has
                  <br />
                  <span className="text-emerald-300">a story.</span>
                </h2>

                <p className="mt-6 max-w-lg text-sm leading-7 text-white/70 xl:text-base">
                  Connect with fellow anglers, discover hidden fishing spots,
                  and share the catch that made your day unforgettable.
                </p>
              ...
              <p className="text-xs text-white/40">
                © 2026 AnglerHub · Built for people who love the water.
              </p>
            </div>
          </section>
        )}
